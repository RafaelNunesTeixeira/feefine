...
class Player(BasePlayer):
    ...
    emp1 = models.IntegerField(max=100, min=0)
    emp2 = models.IntegerField()
    ern1 = models.IntegerField()


class decision(Page):
    form_model = 'player'
    form_fields = ['emp1', 'emp2','ern1']
    @staticmethod
    def vars_for_template(player: Player):
        return dict( case=player.case, p1 = player.p1, p2 = player.p2)
    @staticmethod
    def js_vars(player: Player):
        return dict(jvp1 = player.p1, jvp2 = player.p2, mean1= player.mean1, mean2= player.mean2, case=player.case)
