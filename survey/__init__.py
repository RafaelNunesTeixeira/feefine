...
class rule(Page):
    ...
    def before_next_page(player: Player, timeout_happened):
        player.rule=(player.rul) *1 + 0.5*(50- (player.rul))


page_sequence = [survey, falksc2, falksc, reactance, rule]
